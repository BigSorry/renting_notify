...
class HuurWoningenCrawler(scrapy.Spider):
    name = 'huurwoningen_crawler'
    crawler_output_path = f"./json/{name}.json"
    allowed_domains = ["huurwoningen.nl"]
    start_urls = ['https://www.huurwoningen.nl/in/amersfoort/'
                  '?price=500-1000&radius=25&living_size=25',
                  ]
    huur_filter = '-te-huur'
    ...
    def parse(self, response):
        ...
        links = [
            ...
            if 'huren' in link # filter out other links
        ]
